      ...
      <section className="bg-gray-200 p-2 md:p-6 rounded-2xl mt-6">
        ...
        <div className="text-base md:text-[1.125rem] font-bold p-2 mb-2">
          <h1 className="pl-8 -indent-5">
            ...
            되거나 유출 의심이 되는 경우,
            <br />
            수상한 <span className="text-red-600">URL접속</span>으로 악성앱
            설치가 의심되는 경우
          </h1>
        </div>
        <p
        ...
        >
          ...
          정보 유출된 휴대전화나 PC가 아닌 다른 휴대전화나 PC 사용 권장
        </p>
        <div className="text-[0.875rem] md:text-base p-2 m-4">
          <ul>
            <li className="mb-4">
              <h1 className="font-bold">1) 개인정보 노출 사실 등록</h1>
              <div>
                금감원 개인정보 노출자 사고예방 시스템{" "}
                <LinkExternal label="(pd.fss.or.kr)" href="pd.fss.or.kr" />
                접속
                <br />→ 유의사항 확인 후 동의 체크 <br className="md:hidden" />
                → 등록 및 해제 신청
                ...
                >
                  ...
                  개인정보 노출사실을 등록하면 신규계좌 개설, 신용카드 발급 등
                  제한
                </p>
              </div>
            </li>
            <li className="mb-4">
              ...
              <div>
                ...
                />
                접속
                <br />→ 본인계좌 일괄 지급정지 <br className="md:hidden" />
                → 공동/금융인증서 및 휴대전화 인증
                <br />→ 계좌 조회 → 지급정지 신청
                <br />- 금융회사 영업점을 방문하거나{" "}
                <span className="text-red-600 font-bold">콜센터(전화)</span>를
            ...
            <li className="mb-4">
              ...
              <div>
                ...
                />
                접속
                <br />→ 공동/금융인증서 로그인 <br className="md:hidden" />
                → 가입사실현황조회, 가입제한 서비스
                <br />- 본인 명의 휴대전화 개통 현황 확인 및 신규 개설 차단
                <br />- 명의도용 휴대전화가 개통된 경우, 해당 통신사 등에{" "}
            ...
            <li className="mb-4">
              ...
              <div>
                - 악성앱 삭제 및 휴대전화 초기화{" "}
                <span className="text-red-600 font-bold">
                  (초기화 전까지 휴대전화 전원을 끄거나 비행기모드 권장)
                </span>
                <br />- 휴대전화 제조사 서비스센터를 통해 악성코드 감염 여부
                확인 및 상담
              </div>
            </li>
          </ul>
